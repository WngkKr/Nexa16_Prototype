...
//            FileCopyUtils.copy(inputStream, new FileOutputStream(destination));
    ...
    public NexacroFileResult downloadFile(HttpServletRequest request , @RequestParam String fileName) throws Exception {
        ...
        localFileName = new String(localFileName.getBytes("iso8859-1"), characterEncoding);
...
//        fileName = fileName.replace(".", "");
        ...
        String filePath = getFilePath();
        String realFileName = filePath + SP + localFileName;

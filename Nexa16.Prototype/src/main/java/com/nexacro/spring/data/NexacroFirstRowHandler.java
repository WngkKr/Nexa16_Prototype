    ...
    private void setWriter() {
        ...
        if (this.httpResponse != null && this.writer != null) {
            try {
            	...
            	logger.error("NexacroFirstRowHandler > setWriter > UnsupportedEncodingException ");
            } catch(IllegalStateException e) {
            	logger.error("NexacroFirstRowHandler > setWriter > IllegalStateException ");
            } catch (IOException e) {
            	logger.error("NexacroFirstRowHandler > setWriter > IOException ");
            }
        }
    }

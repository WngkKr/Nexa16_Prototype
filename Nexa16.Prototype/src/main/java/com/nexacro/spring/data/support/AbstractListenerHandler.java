...
public abstract class AbstractListenerHandler {
    ...
    protected final Logger logger = LoggerFactory.getLogger(AbstractListenerHandler.class);
    ...
    public void removeListener(NexacroConvertListener listener) {
        if (listenerList == null || listenerList.getListenerCount() == 0) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("removeListener:"+ " listenerCount=" + listenerCount+ ", listener=" + listener);
            }

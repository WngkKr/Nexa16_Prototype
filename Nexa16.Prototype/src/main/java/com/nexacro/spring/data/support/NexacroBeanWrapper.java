 ...
 */
    ...
    private static class CachedBeanMappings {
        ...
        private void initBeanPropertyNames(BeanWrapper beanWrapper) {
            ...
            int cnt = propertyDescriptors.length;
            for(int idx = 0; idx < cnt; idx++) {
            	PropertyDescriptor descriptor = propertyDescriptors[idx];
                ...
                if(propertyType == boolean.class) {
                    if(!name.startsWith(IS)) {
                        try {
                        	...
                        	LOGGER.error("Occured SecurityException");
                        } catch (NoSuchFieldException e) {
                        	LOGGER.error("Occured NoSuchFieldException");
                        }
                    }
                }
        ...
        private void setStaticReadMethodIntoDescriptor(PropertyDescriptor descriptor, Method staticMethod) {
            ...
            try {
                ...
                // nothing..
            	LOGGER.error("Occured ReflectionFailException");
            }

...
public class NexacroContext {
    ...
    public NexacroContext(final HttpServletRequest httpRequest, final HttpServletResponse httpResponse) throws PlatformException {
        parseRequest(httpRequest, httpResponse);
    }
    
    private void parseRequest(final HttpServletRequest httpRequest,final HttpServletResponse httpResponse) throws PlatformException {
        ...
        HttpPlatformResponse httpPlatformResponse = new HttpPlatformResponse(httpResponse, httpPlatformRequest);
        NexacroFirstRowHandler firstRowHandler    = new NexacroFirstRowHandler(httpResponse, httpPlatformRequest);

...
public class NexacroMappingExceptionResolver extends AbstractHandlerExceptionResolver {
	...
	protected ModelAndView doResolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
		...
		prepareResolveException(request, ex);
	...
	private void prepareResolveException(HttpServletRequest request, Exception ex) {
	...
	private String getLocalizedMessage(String reason) {
		...
		if (this.messageSource != null) {
			localReason = this.messageSource.getMessage(localReason, null,localReason, LocaleContextHolder.getLocale());
		}
		return localReason;
	}

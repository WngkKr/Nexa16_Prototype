...
public class SqlMapClientRowHandler implements RowHandler {
    ...
    private final ObjectToDataSetConverter converter;
    private final NexacroFirstRowHandler firstRowHandler;
    ...
    public SqlMapClientRowHandler(final NexacroFirstRowHandler firstRowHandler, final String resultName, int firstRowCount) {

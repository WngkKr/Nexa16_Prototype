...
public class NexacroIbatisMetaDataProvider {
	...
	*/
	...
	private final Logger logger = LoggerFactory.getLogger(NexacroIbatisMetaDataProvider.class);
	...
	private Class<?> findSqlMapClientCallbackInterface() {
		...
		try {
			...
			logger.error(SPRING_INTERFACE_NAME +" 를 찾을 수 없습니다.");
		}
		...
		if (sqlMapClient == null) {
			try {
				...
				logger.error(EGOVFRAMEWORK_INTERFACE_NAME +" 를 찾을 수 없습니다.");
			}

...
public class NexacroIbatisMetaDataGatherer implements InvocationHandler {
    ...
    public NexacroIbatisMetaDataGatherer(final Dbms dbms, final SqlMapClient sqlMapClient, final String statementName, final Object parameterObject) {
        this.dbms            = dbms;
...
//            sessionScope.setSqlMapTxMgr(sqlMapClient);
    ...
    private MapMetaData executeQuery(StatementScope statementScope, Connection conn, String sqlString, Object[] parameters) throws Exception {
        ...
        try {
            ps = prepareStatement(conn, sqlString);
            ...
            if(ps != null) {
            	try { 
            		...
            		logger.error("Could not close PreparedStatement");
            	}
            }
        }

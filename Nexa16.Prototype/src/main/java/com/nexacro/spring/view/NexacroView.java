...
public class NexacroView extends AbstractView {
	...
	protected final Logger logger = LoggerFactory.getLogger(NexacroView.class);
	protected final Logger performanceLogger = LoggerFactory.getLogger(NexacroConstants.PERFORMANCE_LOGGER);
    ...
    protected void sendResponse(HttpServletRequest request, HttpServletResponse response, PlatformData platformData) throws PlatformException{
        ...
        NexacroContext cachedData = getCachedData();
        ...
        if(logger.isDebugEnabled()) {
        	logger.debug("response contentType=[{}]", platformResponse.getContentType());
    ...
    private NexacroContext getCachedData() {

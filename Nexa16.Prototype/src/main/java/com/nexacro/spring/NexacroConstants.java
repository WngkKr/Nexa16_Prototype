...
public final class NexacroConstants {
    ...
    public final class ERROR_FIRST_ROW {
        ...
        public final static String ERROR_CODE    = ERROR.ERROR_CODE; // nexacro 결과 코드값 (ex '0' 이상 일경우 성공)
        public final static String ERROR_MSG     = ERROR.ERROR_MSG;  // nexacro 에러 메시지
    }
}

(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("22");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("Button05", "absolute", null, "1", "58", "25", "60", null, this.div_search);
            obj.set_taborder("23");
            obj.set_text("조회");
            ...
            obj = new Button("btn_save", "absolute", null, "1", "57", "25", "0", null, this);
            obj.set_taborder("15");
            obj.set_text("저장");
        ...
        ***********************************************************************************/
        ...
        this.fn_save = function(strSvcId)
        {
        	 var oDatas =  {
        			  ...
        			  inds :["dsGroupCode=ds_codeGroupList:U",

(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.style.set_background("transparent URL('img::fileUpDownload/loading.gif')");
            ...
            obj.style.set_background("#1abd9cff URL('img::fileUpDownload/file_btn_AddFiles.png') 12 48");
            ...
            obj.style.set_background("#eb707eff URL('img::fileUpDownload/file_btn_DeleteAll.png') 13 48");
            obj.style.set_border("0 none #808080ff");
            obj.style.set_color("white");
            obj.style.set_padding("0 0 0 30");
            obj.style.set_align("left middle");
            ...
            obj.set_taborder("28");
            obj.set_text("Save");
            obj.style.set_background("#298ae1ff URL('img::fileUpDownload/file_btn_Save.png') 15 48");
            obj.style.set_border("0 none #808080ff");
            obj.style.set_color("white");
            obj.style.set_padding("0 0 0 30");
            obj.style.set_align("left middle");
            ...
            obj = new Layout("default", "", 800, 400, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("Eco File Up&Down");

(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00", "absolute", "2", "385", "250", "21", null, null, this);
            obj.set_taborder("13");
            obj.set_text("리스트 그리드");
            obj.set_cssclass("sta_WF_SubTitle1");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button00", "absolute", null, "389", "100", "12", "319", null, this);
            obj.set_taborder("30");
            obj.set_text("Custom Button");
            obj.set_cssclass("btn_WF_Custom");
            this.addChild(obj.name, obj);

            obj = new Button("Button01", "absolute", null, "389", "65", "12", "254", null, this);
            obj.set_taborder("31");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_Add");
            this.addChild(obj.name, obj);

            obj = new Button("Button02", "absolute", null, "389", "65", "12", "189", null, this);
            obj.set_taborder("32");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            this.addChild(obj.name, obj);

            obj = new Button("Button03", "absolute", null, "385", "79", "21", "109", null, this);
            obj.set_taborder("33");
            obj.set_text("다운로드");
            obj.set_cssclass("btn_WF_Download");
            this.addChild(obj.name, obj);

            obj = new Button("Button04", "absolute", null, "385", "67", "21", "43", null, this);
            obj.set_taborder("34");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_Upload");
            this.addChild(obj.name, obj);

            obj = new Button("Button05", "absolute", null, "385", "21", "21", "20", null, this);
            obj.set_taborder("35");
            obj.set_cssclass("btn_WF_Extend");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid02", "absolute", "0", "86", null, "285", "20", null, this);
            obj.set_taborder("36");
            ...
            obj = new Grid("Grid01", "absolute", "0", "411", null, null, "20", "20", this);
            obj.set_taborder("37");
            obj.set_binddataset("Grid");
            obj.set_scrollbars("autovert");
            obj.set_autofittype("col");
        ...
        // User Script
        this.addIncludeScript("Temp07_MasterDetail(nn).xfdl", "Lib::Comm.xjs");
        this.registerScript("Temp07_MasterDetail(nn).xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("Temp07_MasterDetail(nn).xfdl");

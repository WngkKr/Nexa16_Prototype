(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00", "absolute", "517", "61", "250", "21", null, null, this);
            obj.set_taborder("8");
            obj.set_text("디테일 항목");
            obj.set_cssclass("sta_WF_SubTitle1");
            this.addChild(obj.name, obj);

            obj = new Div("div_Detail", "absolute", "515", "86", null, null, "20", "20", this);
            obj.set_taborder("13");
            this.addChild(obj.name, obj);
            ...
            this.div_Detail.addChild(obj.name, obj);
            obj = new Static("Static18", "absolute", "0", "169", null, null, "0", "0", this.div_Detail);
            obj.set_taborder("39");
            obj.set_cssclass("sta_WF_DetailLabel02");
            this.div_Detail.addChild(obj.name, obj);
            ...
            obj.set_value("true");
            this.div_Detail.addChild(obj.name, obj);
            obj = new CheckBox("CheckBox01", "absolute", "425", "145", "66", "20", null, null, this.div_Detail);
            obj.set_taborder("38");
            obj.set_text("체크02");
            this.div_Detail.addChild(obj.name, obj);
            ...
            obj = new Button("Button12", "absolute", "97", "65", "100", "12", null, null, this);
            obj.set_taborder("18");
            obj.set_text("Custom Button");
            obj.set_cssclass("btn_WF_Custom");
            this.addChild(obj.name, obj);

            obj = new Button("Button13", "absolute", "197", "65", "65", "12", null, null, this);
            obj.set_taborder("19");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_Add");
            this.addChild(obj.name, obj);

            obj = new Button("Button14", "absolute", "262", "65", "65", "12", null, null, this);
            obj.set_taborder("20");
            obj.set_text("행삭제");
            obj.set_cssclass("btn_WF_Delete");
            this.addChild(obj.name, obj);

            obj = new Button("Button17", "absolute", "475", "60", "21", "21", null, null, this);
            obj.set_taborder("23");
            obj.set_cssclass("btn_WF_Extend");
            this.addChild(obj.name, obj);

            obj = new Button("Button15", "absolute", "328", "60", "79", "21", null, null, this);
            obj.set_taborder("24");
            obj.set_text("다운로드");
            obj.set_cssclass("btn_WF_Download");
            this.addChild(obj.name, obj);

            obj = new Button("Button16", "absolute", "406", "60", "67", "21", null, null, this);
            obj.set_taborder("25");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_Upload");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid02", "absolute", "0", "86", "495", null, null, "20", this);
            obj.set_taborder("26");
        ...
        // User Script
        this.addIncludeScript("Temp04_ListDetail2.xfdl", "Lib::Comm.xjs");
        this.registerScript("Temp04_ListDetail2.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("Temp04_ListDetail2.xfdl");

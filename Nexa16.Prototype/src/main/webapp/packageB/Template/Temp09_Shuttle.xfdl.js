(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00", "absolute", "526", "60", "250", "21", null, null, this);
            obj.set_taborder("13");
            obj.set_text("리스트 그리드");
            obj.set_cssclass("sta_WF_SubTitle1");
            this.addChild(obj.name, obj);

            obj = new Button("Button08", "absolute", "490", "374", "29", "29", null, null, this);
            obj.set_taborder("18");
            obj.set_cssclass("btn_WF_ShuttleL");
            this.addChild(obj.name, obj);

            obj = new Button("Button10", "absolute", "490", "406", "29", "29", null, null, this);
            obj.set_taborder("19");
            ...
            obj = new Grid("Grid01", "absolute", "0", "86", "485", null, null, "20", this);
            obj.set_taborder("24");
            obj.set_binddataset("Grid");
            obj.set_scrollbars("autovert");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"28\"/><Column size=\"48\"/><Column size=\"153\"/><Column size=\"150\"/><Column size=\"152\"/><Column size=\"138\"/><Column size=\"143\"/><Column size=\"104\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" style=\"align:center middle;\" text=\"Column0\"/><Cell col=\"1\" text=\"No.\"/><Cell col=\"2\" cssclass=\"CellEssential\" text=\"Essential Edit\"/><Cell col=\"3\" text=\"Combo\"/><Cell col=\"4\" text=\"Calendar\"/><Cell col=\"5\" text=\"Expand\"/><Cell col=\"6\" text=\"Text\"/><Cell col=\"7\" text=\"Number\"/><Cell col=\"8\" text=\"Button\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" style=\"align:center middle;\" text=\"bind:Column0\"/><Cell col=\"1\" style=\"align:center middle;\" text=\"bind:순번\"/><Cell col=\"2\" displaytype=\"text\" edittype=\"text\" style=\"padding:3 3 3 3;\" text=\"bind:Column01\" editdisplay=\"display\"/><Cell col=\"3\" displaytype=\"combo\" edittype=\"combo\" style=\"padding:3 3 3 3;\" text=\"bind:Column02\" combodisplay=\"display\"/><Cell col=\"4\" displaytype=\"date\" edittype=\"date\" style=\"padding:3 3 3 3;\" text=\"bind:Column03\" calendardisplay=\"display\" calendardisplaynulltype=\"default\"/><Cell col=\"5\" displaytype=\"text\" edittype=\"expand\" style=\"padding:3 3 3 3;\" text=\"bind:Column04\" expandshow=\"show\" expandsize=\"21\" expandimage=\"URL('img::btn_WF_SearchSmall.png')\"/><Cell col=\"6\" style=\"padding:3 3 3 3;\" text=\"bind:Column05\"/><Cell col=\"7\" style=\"align:right middle;padding:3 3 3 3;\" text=\"bind:Column06\"/><Cell col=\"8\" displaytype=\"button\" edittype=\"button\" style=\"align:center middle;padding:3 3 3 3;\" text=\"bind:Column07\"/></Band><Band id=\"summary\"><Cell colspan=\"7\" cssclass=\"center middle\" text=\"합계\"/><Cell col=\"7\" colspan=\"2\" style=\"align:right middle;padding:0 11 0 0;\" text=\"321456789\" mask=\"###,###,###\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00", "absolute", "524", "86", null, null, "20", "20", this);
            obj.set_taborder("25");
            obj.set_binddataset("Grid");
            obj.set_scrollbars("autovert");
        ...
        // User Script
        this.addIncludeScript("Temp09_Shuttle.xfdl", "Lib::Comm.xjs");
        this.registerScript("Temp09_Shuttle.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("Temp09_Shuttle.xfdl");

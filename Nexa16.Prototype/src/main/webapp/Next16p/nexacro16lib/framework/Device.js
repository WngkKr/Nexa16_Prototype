...
if (!nexacro.DeviceI)
{
	...
	_pDeviceI.keyEvent = function(keytype, keyaction)
	{
        ...
        return _application.getActiveForm()._on_devicebuttonup({button:_keyKind});	
	};
...
if (nexacro.System)
{
    nexacro.System.prototype = function()
    {
		...
		if (nexacro.Device.curDevice == 1)
		{
		    ...
		    this.navigatorversion = "16";							// "16"로 고정
...
if (nexacro.Phone)
{
    nexacro.Phone.prototype = function ()
    {
        this._id = nexacro.Device.makeID();
        nexacro.Device._userCreatedObj[this._id] = this;
    };

    nexacro.Phone.prototype.destroy = function ()
    {
        delete nexacro.Device._userCreatedObj[this._id];
        return true;
    };

...
if (!nexacro.Device || nexacro._OS == "iOS")
{
...
if (!nexacro.Device || nexacro._OS == "Android" || nexacro._OS == "iOS")
{
    if (!nexacro.VirtualFile)
    {
        nexacro.VirtualFile = function (id, parent)
        {
            if (nexacro._OS == "iOS")
            {
                this._id = nexacro.Device.makeID();  //only iOS 
        ...
        _pVirtualFile.remove = function (strFilePath)
        {
			...
			if (nexacro._OS == "iOS")
			{
				...
				var iosfilepath = "";
				 ...
				 {
					var _filecache = _application._getFileCache(strFilePath);
					if (null != _filecache)
					{
		...
		_pVirtualFile._onerror = function (objData) //iOS
		{

...
if (!nexacro.Chart)
{
    ...
    _pChart.on_updateLegendLayout = function() 
    {
        ...
        // init remain area
    	var rc = new nexacro.Rect(0, 0, this._getClientWidth(), this._getClientHeight());
    ...
    _pChartTitle._defaultLocation = "top";
    _pChartTitle._defaultRotate = 0;
    ...
    _pChartTitle._recalcLayout = function() 
    {
        ...
        if (this.subtext.length) 
        {
            ...
            var subtextsize = nexacro._getTextSize(this.subtext, subfont);
...
//            var offset_x = this._client_rect.getHeight();
            var offset_x = this._getClientWidth();
            if (this._text_width) 
            {
                font = curstyle.font;
        ...
        {
            var offset_y = this._getClientWidth();
            if (this._text_width) 
            {
                font = curstyle.font;
                color = curstyle.color ? curstyle.color._value : "black";
   ...
   //==============================================================================
    ...
    _pChartLegend._defaultLocation = "top";
    _pChartLegend._defaultType = "multi";
        ...
        if (this.id == "xaxis") 
        {
            ...
            if (dataset) 
            {
                ...
                for (var row = 0; row < cnt; row++) 
                {
                    ...
                    textsize = nexacro._getTextSize(text, font);
                    ...
                    for (var s = 0; s < series_cnt; s++) 
                    {
                        ...
                        if (used) 
                        {
                            ...
                            for (var row = 0; row < cnt; row++) 
                            {
                                ...
                                text_offset = nexacro._getTextSize(""+_text, series.currentstyle.datatextfont)[1];
                        ...
                        for (var i = 0; i < item_cnt; i++) 
                        {
                            ...
                            if (val != undefined) 
                            {
                                ...
                                if (text != "") 
                                {
                                    ...
                                    var textsize = nexacro._getTextSize(text, text_font);

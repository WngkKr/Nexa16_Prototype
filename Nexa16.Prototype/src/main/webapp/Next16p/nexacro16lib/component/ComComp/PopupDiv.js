...
if (!nexacro.PopupDiv)
{
    ...
    _pPopupDiv._accessibility_role = "form";
    ...
    _pPopupDiv.on_created = function (_window)
    {
       ...
       // nexacro.PopupControl.prototype.on_created.call(this, _window);
    ...
    _pPopupDiv.on_created_contents = function (win)
    {
    	...
    	if (!this.visible && control_elem)
    	{
    		...
    		control_elem.setElementLineHeight(this._getCurrentStyleInheritValue("lineHeight"));
    ...
    _pPopupDiv.on_attach_contents_handle = _pPopupDiv.on_created;
    ...
    {
        if (this._is_init && _application.getActiveForm())
        {
            var formEventList = _application.getActiveForm()._event_list;

...
if (!nexacro.FileDownload)
{
    ...
    /* accessibility */
    _pFileDownload._accessibility_role = "button";

    //===============================================================
    // nexacro.FileDownload : Create & Update
    //===============================================================
    ...
    _pFileDownload.download = function (url, targetpath)
	{
		...
		if (url != undefined )
		{
		    ...
		    nexacro._download(url, this._hidden_frame_handle, initname, targetpath);
		    ret = true;
		}	
   		else if (downloadurl && downloadurl != undefined && downloadurl != "")
		{
   			downloadurl = nexacro._getServiceLocation(downloadurl);
   			nexacro._download(downloadurl, this._hidden_frame_handle, initname, targetpath);
		    ret = true;
   		}
		return ret;
	};

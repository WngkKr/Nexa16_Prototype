...
if (!nexacro.ScrollBarControl)
{
    ...
    nexacro.ScrollBarControl = function (id, position, left, top, width, height, right, bottom, parent)
    {
    ...
    _pScrollBar.barminsize = -1;
    _pScrollBar.baroutsize = -1;
    _pScrollBar.decbuttonsize = -1;
    _pScrollBar.imgoutsize = -1;
    _pScrollBar.incbuttonsize = -1;    
    _pScrollBar.trackbarsize = -1;
    ...
    _pScrollBar.on_create_contents = function ()
    {
        ...
        if (control_elem)
        {
            this.decbutton = new nexacro.Button("decbutton", "absolute", 0, 0, 0, 0, null, null, this);
        	this.incbutton = new nexacro.Button("incbutton", "absolute", 0, 0, 0, 0, null, null, this);
        	this.trackbar = new nexacro.Button("trackbar", "absolute", 0, 0, 0, 0, null, null, this);
    ...
    _pScrollBar.on_incbutton_lbuttondown = function (obj)
    {
        ...
        else if (newpos >= max)
        {
            ...
            this.on_fire_onscroll(this.pos, (this.direction == "vertical" ? "linedown" : "lineright"));
    ...
    _pScrollBar.on_decbutton_lbuttondown = function (obj)
    {
        ...
        else if (newpos <= min)
        {
            ...
            this._pos = posarr[1];
            // Fire OnScroll - SCROLL_LINE
            this.on_fire_onscroll(this.pos, (this.direction == "vertical" ? "lineup" : "lineleft"));
    ...
    _pScrollBar._getScrollInfo = function (oldpos, newpos, min, max)
    {
        var str = "";
    ...
    _pScrollBar._recalcLayout = function ()
    {
        ...
        if (control_elem && this._is_created_contents)
        {
            ...
            var decsize = this.decbuttonsize;
            var incsize = this.incbuttonsize;
            var tracksize = 0;
            if (this.direction == "vertical")
            {
    ...
    _pScrollBar._resetTrackBar = function (l, t, r, b)
    {
        ...
        if (size > 0)
        {
            ...
            {
                var shaftsize = b - t;
                var trackstart = ((pos - min) * (shaftsize - tracksize) / size) | 0;
...
if (!nexacro.ScrollIndicatorControl)
{
    ...
    nexacro.ScrollIndicatorControl = function (id, position, left, top, width, height, right, bottom, parent)
    {
        nexacro.ScrollBarControl.call(this, id, position, left, top, width, height, right, bottom, parent);
    };
    ...
    _pScrollIndicatorControl.set_barminsize = function (v)
    {
        v = nexacro._toInt(v);
        if (this.barminsize != v)
        {
    ...
    _pScrollIndicatorControl.set_baroutsize = function (v)
    {
        v = nexacro._toInt(v);
        if (this.baroutsize != v)
        {

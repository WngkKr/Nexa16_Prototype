...
if (!nexacro.StatusBarControl)
{
    ...
    //==============================================================================
    nexacro.StatusBarControl = function(id, position, left, top, width, height, right, bottom, parent) 
    {
    ...
    {
    	var resizegrip = this.resizegrip = new nexacro._Icon("resizegrip", "absolute", 0, 0, 0, 0, null, null, this);
    ...
    _pStatusBarControl.on_apply_resizable = function (resizable)
    {
    	...
    	if (ownerframe && resizegrip)
    	{
    		...
    		if (resizable && ownerframe._is_window)
    			var hittest_type = "resizingborder_bottomright";
    		else
    ...
    _pStatusBarControl.on_create_contents = function() 
    {
        ...
        if (control_elem) 
        {            
        	var statustext = this.statustext = new nexacro.Static("statustext", "absolute", 0, 0, 0, 0, null, null, this);
            ...
            var progressbar = this.progressbar = new nexacro.ProgressBar("progressbar", "absolute", 0, 0, 0, 0, null, null, this);
            ...
            var resizegrip = this._createResizeGrip();            

...
{  
	...
	if(nexacro.Phone)
	{
	    nexacro.Phone.makeCall = function (strPhoneNumber, bAutoDialing) { };
	}
}
...
if (!nexacro.Sms)
{
	...
	_pSms.sendMessage = function(strPhoneNumber, strMessage)
	{
	    if (nexacro.Device.curDevice == 1)
	    {
	        ...
	        if (Number(nexacro._OSVersion.substring(0, 1)) < 4)
	        {
				this.sendUnsupportedFunc();
				return false;
			}
...
if (nexacro._OS == "iOS" && !nexacro.VirtualFile)
{
    ...
    // 2013.11.18 v13변경 스펙에 deprecated.
    /*
    _pVirtualFile.remove = function (strFilePath)
	{
		...
		{			
			...
			{
				var _filecache = nexacro._getFileCache(strFilePath);
				if (null != _filecache)
				{
					this.EnvironmentPath = 3;
    ...
    _pLiteDBConnection.open = function (strDataSource, constOpenFlag)
    {
        ...
        if (this.paramck_asyncOpen(this.datasource, this.openflag))
        {
            ...
            if (nexacro.Device.curDevice == 0)
            {
	        	...
	        	{
	        		var _filecache = nexacro._getFileCache(this.datasource);
	        		if (null != _filecache)
	        		{
	            		EnvironmentPath = "3";
...
//==============================================================================
if (nexacro._OS == "iOS" && !nexacro.XPushEventInfo)
{
...
//==============================================================================
if (nexacro._OS == "iOS" && !nexacro.XPushErrorEventInfo)
{
...
//XPush
//==============================================================================
if (nexacro._OS == "iOS" && !nexacro.XPushKeepAliveEventInfo)
{
    ...
    delete _pXPushKeepAliveEventInfo;
}
...
//XPush
//==============================================================================
if (nexacro._OS == "iOS" && !nexacro.XPushRequestMessageCountEventInfo)
{
...
//nexacro.XPush
//==============================================================================
if (nexacro._OS == "iOS" && !nexacro.CommandControl)
{
    ...
    var _pCommandControl = nexacro.CommandControl.prototype = nexacro._createPrototype(nexacro._EventSinkObject, nexacro.CommandControl);	
...
if (nexacro._OS == "iOS" && !nexacro.XPush)
{
...
//		this.channeltype; //only single
    ...
    var _pXPush = nexacro.XPush.prototype = nexacro._createPrototype(nexacro._EventSinkObject, nexacro.XPush);
    ...
    _pXPush._onsuccess = function (objData)
    {
		...
		{
			if(command)	command.actiontype = objData.classtype;	
